-- First Chair — Seed Data
\c first_chair

-- Seed Users (password: FirstChair2025! for all)
-- bcrypt hash of FirstChair2025!
INSERT INTO users (id, name, email, password_hash, role, force_password_change) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'System Admin', 'admin@firstchair.law', '$2b$10$ZGhVb0RYL1BSOU9LTkxHSuKQ8fVJ6q2e3x5c7w9YkN1mA4pB6rDgO', 'admin', true),
  ('a2000000-0000-0000-0000-000000000002', 'Maria Santos', 'paralegal@firstchair.law', '$2b$10$ZGhVb0RYL1BSOU9LTkxHSuKQ8fVJ6q2e3x5c7w9YkN1mA4pB6rDgO', 'paralegal', true),
  ('a3000000-0000-0000-0000-000000000003', 'David Chen', 'supervisor@firstchair.law', '$2b$10$ZGhVb0RYL1BSOU9LTkxHSuKQ8fVJ6q2e3x5c7w9YkN1mA4pB6rDgO', 'supervisor', true),
  ('a4000000-0000-0000-0000-000000000004', 'James Richardson', 'attorney@firstchair.law', '$2b$10$ZGhVb0RYL1BSOU9LTkxHSuKQ8fVJ6q2e3x5c7w9YkN1mA4pB6rDgO', 'attorney', true),
  ('a5000000-0000-0000-0000-000000000005', 'Lisa Park', 'records@firstchair.law', '$2b$10$ZGhVb0RYL1BSOU9LTkxHSuKQ8fVJ6q2e3x5c7w9YkN1mA4pB6rDgO', 'records_team', true);
